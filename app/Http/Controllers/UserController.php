...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // ✅ REFACTORED OFFICE MAP WITH ABBREVIATIONS (22 Characters Max)
        ...
        $officeMap = [
            ...
            "MONKAYO" => ["Monkayo MOO"], // Municipal Operations Office
            "COMPOSTELA" => ["Compostela MOO"],
            "MONTEVISTA" => ["Montevista MOO"],
            "NEW BATAAN" => ["New Bataan MOO"],
            "MARAGUSAN (SAN MARIANO)" => ["Maragusan MOO"],
            "NABUNTURAN (Capital)" => ["Nabunturan MOO"],
            "MAWAB" => ["Mawab MOO"],
            "MACO" => ["Maco MOO"],
            "PANTUKAN" => ["Pantukan MOO"],
            "MABINI (DOÑA ALICIA)" => ["Mabini MOO"],
            "LAAK (SAN VICENTE)" => ["Laak MOO"],
            "ASUNCION (SAUG)" => ["Asuncion MOO"],
            "BRAULIO E. DUJALI" => ["B. E. Dujali MOO"],
            "CARMEN" => ["Carmen MOO"],
            "KAPALONG" => ["Kapalong MOO"],
            "NEW CORELLA" => ["New Corella MOO"],
            "SAN ISIDRO" => ["San Isidro MOO"],
            "SANTO TOMAS" => ["Santo Tomas MOO"],
            "TALAINGOD" => ["Talaingod MOO"],
            "CITY OF TAGUM (Capital)" => ["Tagum City Office"], // City office
            "CITY OF PANABO" => ["Panabo City Office"],
            "ISLAND GARDEN CITY OF SAMAL" => ["Samal City Office"],
            "BANSALAN" => ["Bansalan MOO"],
            "HAGONOY" => ["Hagonoy MOO"],
            "KIBLAWAN" => ["Kiblawan MOO"],
            "MAGSAYSAY" => ["Magsaysay MOO"],
            "MALALAG" => ["Malalag MOO"],
            "MATANAO" => ["Matanao MOO"],
            "PADADA" => ["Padada MOO"],
            "SANTA CRUZ" => ["Sta. Cruz MOO"],
            "CITY OF DIGOS (Capital)" => ["Digos City Office"],
            "SULOP" => ["Sulop MOO"],
            "BAGANGA" => ["Baganga MOO"],
            "BANAYBANAY" => ["Banaybanay MOO"],
            "BOSTON" => ["Boston MOO"],
            "CARAGA" => ["Caraga MOO"],
            "CATEEL" => ["Cateel MOO"],
            "GOVERNOR GENEROSO" => ["Gov. Generoso MOO"],
            "LUPON" => ["Lupon MOO"],
            "MANAY" => ["Manay MOO"],
            "CITY OF MATI (Capital)" => ["Mati City Office"],
            "SAN ISIDRO" => ["San Isidro MOO"],
            "TARRAGONA" => ["Tarragona MOO"],
            "DON MARCELINO" => ["Don Marcelino MOO"],
            "JOSE ABAD SANTOS (TRINIDAD)" => ["J. A. Santos MOO"],
            "MALITA" => ["Malita MOO"],
            "SANTA MARIA" => ["Sta. Maria MOO"],
            "SARANGANI" => ["Sarangani MOO"],
        ];
