...
<script>
    // Keep hidden field updated when receiver is changed
    const receiverSelect = document.getElementById('to_receiver');
    const hiddenReceiver = document.getElementById('hidden_receiver');
    const filterForm = document.getElementById('filterForm');

    // When receiver changes, update hidden field
    receiverSelect.addEventListener('change', function() {
        hiddenReceiver.value = this.value;
    });

    // When submitting the filter form, also copy current receiver
    filterForm.addEventListener('submit', function() {
        hiddenReceiver.value = receiverSelect.value;
    });

    // On page load, if a receiver was selected (via request()), restore it
