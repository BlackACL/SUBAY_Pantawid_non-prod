<x-app-layout>
    ...
    <div class="p-6">
        ...
        {{-- Summary Cards Row 2 - New Cards --}}
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            {{-- Verified FETS (Need Approval) --}}
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-sm font-medium">Verified FETS</p>
                        <h3 class="text-3xl font-bold text-gray-800 mt-2" id="verified-fets">{{ $verifiedFets }}</h3>
                    </div>
            ...
            {{-- Regional Inventory Units --}}
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-sm font-medium">My Inventory Units</p>
                        <h3 class="text-3xl font-bold text-gray-800 mt-2" id="regional-inventory">{{ $regionalInventoryCount }}</h3>
                    </div>
            ...
            {{-- All Employee & Provincial DPSC Inventory --}}
