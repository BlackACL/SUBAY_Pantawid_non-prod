<x-RegionalAdmin-layout>
    ...
    <div
     ...
     ">
        ...
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-6 py-6 pb-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-4 mb-8"> <!-- Added mb-8 for more bottom margin -->
                        {{ $inventory->links() }}
                    </div>
                </div>
            </div>
        ...
        >
            <div class="bg-white rounded-lg w-11/12 max-w-6xl h-[90vh] flex flex-col shadow-lg overflow-hidden [border-bottom-left-radius:0.5rem] [border-bottom-right-radius:0.5rem]">
...
<script>
    // Remove overflow-hidden on page load to ensure sidebar is visible
    ...
    const returnFetsButton = document.getElementById('returnFetsButton');
    const returnFetsModal = document.getElementById('returnFetsModal');
    const closeReturnModal = document.getElementById('closeReturnModal');
    const returnFetsIframe = document.getElementById('returnFetsIframe');

    const fetsRoute = "{{ route('fets.select.embed') }}";
    const returnFetsRoute = "{{ route('fets.return.modal') }}"; // new route for Return FETS
