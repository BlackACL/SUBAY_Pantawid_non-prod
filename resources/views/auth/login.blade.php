        ...
        <div>
            ...
            <div class="relative">
                <input id="password" name="password" type="password" required
                    ...
                    style="background-image: none !important; background-color: #cbcbe4 !important;">
                <button type="button" onclick="togglePasswordVisibility()" tabindex="-1" 
                        class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-600 focus:outline-none" style="pointer-events: auto;">
