        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="mb-4 flex items-center justify-between gap-4">
                    <form method="GET" action="{{ route('superadmin.inventory') }}" class="mb-4 flex flex-wrap items-center gap-4">
                        <div>
                ...
                <div class="overflow-x-auto">
                    <table class="table-fixed w-full border text-sm" style="min-width: 1800px;">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="16" class="text-center py-4">No data found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
